    ...
    public static function createPlayers($game, $link) {
        ...
        $sql = 'CREATE TABLE players_' . $game['ts'] . '
            (
                ...
                `has_chest` TINYINT(1) NOT NULL DEFAULT "0" ,
                `is_weed` TINYINT(1) NOT NULL DEFAULT "0" ,
                `is_lighthouse` TINYINT(1) NOT NULL  DEFAULT "0",
                `is_ben` TINYINT(1) NOT NULL  DEFAULT "0",
                `is_missionary` TINYINT(1) NOT NULL  DEFAULT "0",
                `is_friday` TINYINT(1) NOT NULL  DEFAULT "0",
                `is_missionary_drunk` TINYINT(1) NOT NULL  DEFAULT "0",
                `ship_tile` INT NOT NULL DEFAULT "0",
                `p1_alive` TINYINT(1) NOT NULL  DEFAULT "0",
                `p2_alive` TINYINT(1) NOT NULL  DEFAULT "0",
                `p3_alive` TINYINT(1) NOT NULL  DEFAULT "0",
                `ben_alive` TINYINT(1) NOT NULL  DEFAULT "0",
                `missionary_alive` TINYINT(1) NOT NULL  DEFAULT "0",
                `friday_alive` TINYINT(1) NOT NULL  DEFAULT "0",
                `p1_disabled` TINYINT(1) NOT NULL  DEFAULT "0",
                `p2_disabled` TINYINT(1) NOT NULL  DEFAULT "0",
                `p3_disabled` TINYINT(1) NOT NULL  DEFAULT "0",
                `ben_disabled` TINYINT(1) NOT NULL  DEFAULT "0",
                `missionary_disabled` TINYINT(1) NOT NULL  DEFAULT "0",
                `friday_disabled` TINYINT(1) NOT NULL  DEFAULT "0",
                `p1_coins` INT NOT NULL  DEFAULT "0",
                `p2_coins` INT NOT NULL  DEFAULT "0",
                `p3_coins` INT NOT NULL  DEFAULT "0",
                `ben_coins` INT NOT NULL  DEFAULT "0",
                `missionary_coins` INT NOT NULL  DEFAULT "0",
                `friday_coins` INT NOT NULL  DEFAULT "0",
                `p1_chest` TINYINT(1) NOT NULL  DEFAULT "0",
                `p2_chest` TINYINT(1) NOT NULL  DEFAULT "0",
                `p3_chest` TINYINT(1) NOT NULL  DEFAULT "0",
                `ben_chest` TINYINT(1) NOT NULL  DEFAULT "0",
                `missionary_chest` TINYINT(1) NOT NULL  DEFAULT "0",
                `friday_chest` TINYINT(1) NOT NULL  DEFAULT "0",
                `p1_can_attack` TINYINT(1) NOT NULL  DEFAULT "0",
                `p2_can_attack` TINYINT(1) NOT NULL  DEFAULT "0",
                `p3_can_attack` TINYINT(1) NOT NULL  DEFAULT "0",
                `ben_can_attack` TINYINT(1) NOT NULL  DEFAULT "0",
                `missionary_can_attack` TINYINT(1) NOT NULL  DEFAULT "0",
                `friday_can_attack` TINYINT(1) NOT NULL  DEFAULT "0",
                `p1_water` TINYINT(1) NOT NULL  DEFAULT "0",
                `p2_water` TINYINT(1) NOT NULL  DEFAULT "0",
                `p3_water` TINYINT(1) NOT NULL  DEFAULT "0",
                `ben_water` TINYINT(1) NOT NULL  DEFAULT "0",
                `missionary_water` TINYINT(1) NOT NULL  DEFAULT "0",
                `friday_water` TINYINT(1) NOT NULL  DEFAULT "0",
                `p1_aboard` TINYINT(1) NOT NULL  DEFAULT "0",
                `p2_aboard` TINYINT(1) NOT NULL  DEFAULT "0",
                `p3_aboard` TINYINT(1) NOT NULL  DEFAULT "0",
                `ben_aboard` TINYINT(1) NOT NULL  DEFAULT "0",
                `missionary_aboard` TINYINT(1) NOT NULL  DEFAULT "0",
                `friday_aboard` TINYINT(1) NOT NULL  DEFAULT "0",
                `p1_helicopter` TINYINT(1) NOT NULL  DEFAULT "0",
                `p2_helicopter` TINYINT(1) NOT NULL  DEFAULT "0",
                `p3_helicopter` TINYINT(1) NOT NULL  DEFAULT "0",
                `ben_helicopter` TINYINT(1) NOT NULL  DEFAULT "0",
                `missionary_helicopter` TINYINT(1) NOT NULL  DEFAULT "0",
                `friday_helicopter` TINYINT(1) NOT NULL  DEFAULT "0",
                `p1_tile` INT NOT NULL  DEFAULT "0",
                `p2_tile` INT NOT NULL  DEFAULT "0",
                `p3_tile` INT NOT NULL  DEFAULT "0",
                `ben_tile` INT NOT NULL  DEFAULT "0",
                `missionary_tile` INT NOT NULL  DEFAULT "0",
                `friday_tile` INT NOT NULL  DEFAULT "0",
                `p1_level` INT NOT NULL  DEFAULT "0",
                `p2_level` INT NOT NULL  DEFAULT "0",
                `p3_level` INT NOT NULL  DEFAULT "0",
                `ben_level` INT NOT NULL  DEFAULT "0",
                `missionary_level` INT NOT NULL  DEFAULT "0",
                `friday_level` INT NOT NULL DEFAULT "0",
                `move_locked` VARCHAR(30) NOT NULL DEFAULT "0",
                `rum_disabled` VARCHAR(30) NOT NULL DEFAULT "0",
                `prev_tile_id` INT NOT NULL  DEFAULT "0"
            )';
